...
Po uruchomieniu aplikacji użytkownik zostaje przeniesiony na stronę domową. Znajdzie swoje notatki i zeszyty, jak również dodatkowe elementy w menu górnego paska, pozwalające na utowrzenie nowej notatki, zmianę motywu, czy reset bazy danych w celu usunięcia wszystkich notatek. 
...
Dla osób, które mogę mieć problemy z widocznością tekstu przy głównych ustawieniach wielkości i kolorów aplikacji przygotowany został mowtyw \textbf{easy}, którego kolory bardziej ze sobą kontrastują, jak również rozmiary czcionek, ikon, przycisków i paska narzędzi notatek zwiększają się.
