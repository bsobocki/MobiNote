...
\subsubsection{Zawiera}

\begin{itemize}
    \item przyciski zapisu i powrotu(ikona strzałki w lewo)
    \item edytora tytułu
    \item przycisku typu \textbf{\textit{switch}}
\end{itemize}
...
Ostatnim elementem paska jest \textbf{przycisk zmiany opcji zapisu}. Jest to przycisk typu \textbf{switch} domyślnie ustawiony na true, czyli zapis notatki w przypadku edycji. Jego kliknięcie zmienia wartość. Ustawienie tego elementu na false oznacza brak zapisu stanu notatki nawet jeśli została ona zmieniona.
