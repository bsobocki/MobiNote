...
class $TagNotesTable extends TagNotes with TableInfo<$TagNotesTable, TagNote> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TagNotesTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  String get aliasedName => _alias ?? 'tag_notes';
  @override
  String get actualTableName => 'tag_notes';
  @override
  VerificationContext validateIntegrity(Insertable<TagNote> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  TagNote map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TagNote(
  ...
  @override
  $TagNotesTable createAlias(String alias) {
    return $TagNotesTable(attachedDatabase, alias);
  }
}

class TagNote extends DataClass implements Insertable<TagNote> {
  final int tagId;
  final int noteId;
  const TagNote({required this.tagId, required this.noteId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  TagNotesCompanion toCompanion(bool nullToAbsent) {
    return TagNotesCompanion(
      tagId: Value(tagId),
      noteId: Value(noteId),
    );
  }

  factory TagNote.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return TagNote(
  ...
  TagNote copyWith({int? tagId, int? noteId}) => TagNote(
        tagId: tagId ?? this.tagId,
        noteId: noteId ?? this.noteId,
      );
  @override
  String toString() {
    return (StringBuffer('TagNote(')
          ..write('tagId: $tagId, ')
          ..write('noteId: $noteId')
          ..write(')'))
        .toString();
...
class TagNotesCompanion extends UpdateCompanion<TagNote> {
  final Value<int> tagId;
  final Value<int> noteId;
  final Value<int> rowid;
  const TagNotesCompanion({
    this.tagId = const Value.absent(),
    this.noteId = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  TagNotesCompanion.insert({
    required int tagId,
    required int noteId,
    this.rowid = const Value.absent(),
  })  : tagId = Value(tagId),
        noteId = Value(noteId);
  static Insertable<TagNote> custom({
  ...
  TagNotesCompanion copyWith(
      {Value<int>? tagId, Value<int>? noteId, Value<int>? rowid}) {
    return TagNotesCompanion(
      tagId: tagId ?? this.tagId,
      noteId: noteId ?? this.noteId,
  ...
  @override
  String toString() {
    return (StringBuffer('TagNotesCompanion(')
          ..write('tagId: $tagId, ')
          ..write('noteId: $noteId, ')
          ..write('rowid: $rowid')
          ..write(')'))
...
abstract class _$MobiNoteDatabase extends GeneratedDatabase {
  _$MobiNoteDatabase(QueryExecutor e) : super(e);
  late final $NotesTable notes = $NotesTable(this);
  late final $TagsTable tags = $TagsTable(this);
  late final $TagNotesTable tagNotes = $TagNotesTable(this);
  @override
  Iterable<TableInfo<Table, Object?>> get allTables =>
      allSchemaEntities.whereType<TableInfo<Table, Object?>>();
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [notes, tags, tagNotes];
}
